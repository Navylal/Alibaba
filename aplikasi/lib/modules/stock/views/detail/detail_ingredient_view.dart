...
class DetailIngredientView extends StatelessWidget {
  const DetailIngredientView({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Icon(Icons.inventory_2, size: 45, color: cs.primary),
                ),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          Get.back();
                          Get.toNamed('/edit-ingredient', arguments: item);
                        },
